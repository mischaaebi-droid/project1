            ...
            <div class="portrait-card newspaper-card">
                ...
                <div class="square-chart">
                    ...
                    <div class="proposal-section">
                        <h3>${interpellations} Questions</h3>
                    ...
                    <div class="proposal-section">
                        <h3>${motionsAndPostulates} Demands</h3>
                        <div class="proposal-grid">
                    ...
                    <div class="legend">
                        <span><i class="legend-square interpellation-square"></i> Interpellation</span>
                        <span><i class="legend-square motion-square"></i> Motion / Postulat</span>
                        <span><i class="legend-square successful-demo">✓</i> Successful</span>
                    </div>
